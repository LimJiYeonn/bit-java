...
public class Mysql {
   ...
   static final String DB_URL = "jdbc:mysql://3.89.120.91:3306/db01?&useSSL=false"; //접속할 DB 서버
//   static final String DB_URL = "jdbc:mysql://localhost/db01?&useSSL=false";
   static final String USER_NAME = "6jo"; //DB에 접속할 사용자 이름을 상수로 정의
   ...
   void Insert() {
      try{
         ...
         String sql = " insert into table07 values(null , ? , ? , ? , ?)";
   ...
   void Select() {
      ...
      try{
         ...
         String sql = "select * from table07";
   ...
   void Update() {
      ...
      try{
         ...
         String sql = "update table07 set name = ? ,kor = ? , eng = ?, mat = ? where id = ?";
   ...
   void Delete() {
      ...
      try{
         ...
         String sql = "delete from table07 where id = ?";  
         state = conn.prepareStatement(sql);
